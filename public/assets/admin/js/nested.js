!(function (t, e, s, i) {
    function o(e, o) {
        (this.w = t(s)),
            ...
            (o = o || a).rootClass !== i &&
                "dd" !== o.rootClass &&
                ((o.listClass = o.listClass ? o.listClass : o.rootClass + "-list"),
        ...
        a = {
            ...
            itemRenderer: function (e, s, i, o, n) {
                var l = t
                    ...
                    a = "<" + o.itemNodeName + l + ">";
                return (
                    (a += "<" + o.handleNodeName + ' class="' + o.handleClass + '">'),
    ...
    (o.prototype = {
        init: function () {
                ...
                s.el.on("click", "button", function (e) {
                    if (!s.dragEl) {
                        var i = t(e.currentTarget),
                            o = i.data("action"),
                            n = i.parents(s.options.itemNodeName).eq(0);
            ...
            n && (s.el[0].addEventListener("touchstart", o, !1), e.addEventListener("touchmove", l, !1), e.addEventListener("touchend", a, !1), e.addEventListener("touchcancel", a, !1)),
                s.el.on("mousedown", o),
                s.w.on("mousemove", l),
                s.w.on("mouseup", a);
            s.el.bind("destroy-nestable", function () {
                n && (s.el[0].removeEventListener("touchstart", o, !1), e.removeEventListener("touchmove", l, !1), e.removeEventListener("touchend", a, !1), e.removeEventListener("touchcancel", a, !1)),
        ...
        add: function (e) {
            ...
            e.parent_id !== i &&
                ((o = o.find('[data-id="' + e.parent_id + '"]')), delete e.parent_id, 0 === o.children(s).length && (o = o.append(this.options.listRenderer("", this.options))), (o = o.find(s + ":first")), this.setParent(o.parent())),
        ...
        removeItem: function (e) {
            ...
            t(i).find(o).remove();
            t(i)
                .find('[data-action="expand"], [data-action="collapse"]')
                .each(function () {
        ...
        remove: function (t, e) {
            var s = this.options,
                i = this,
                o = this._getItemById(t),
                n = s.effect.animation || "fade",
                l = s.effect.time || "slow";
            "fade" === n
                ? o.fadeOut(l, function () {
                      i.removeItem(o);
                  })
                : this.removeItem(o),
                e && e();
        ...
        removeAll: function (e) {
            ...
            var i = this,
                o = this.options,
                n = i.el.find(o.listNodeName).first(),
                l = n.children(o.itemNodeName),
                a = o.effect.animation || "fade",
                r = o.effect.time || "slow";
        ...
        _buildItem: function (e, s) {
            ...
            var l = s.contentCallback(e),
                a = this._buildList(e.children, s),
                r = t(s.itemRenderer(n, l, a, s, e));
        ...
        serialize: function () {
            var e = this,
                s = function (i) {
                    var o = [];
                    return (
                        i.children(e.options.itemNodeName).each(function () {
                            var i = t(this),
                                n = t.extend({}, i.data()),
                                l = i.children(e.options.listNodeName);
        ...
        asNestedSet: function () {
            function e(i, l, a) {
                var r,
                    ...
                    h = a + 1;
                return (
                    t(i).children(o.listNodeName).children(o.itemNodeName).length > 0 &&
                        (l++,
                        t(i)
                            .children(o.listNodeName)
                            .children(o.itemNodeName)
                            .each(function () {
                                h = e(t(this), l, h);
                            }),
                        l--),
                    (r = t(i).attr("data-id")),
                    s(r) && (r = parseInt(r)),
                    (d = t(i).parent(o.listNodeName).parent(o.itemNodeName).attr("data-id") || ""),
                    s(d) && (d = parseInt(d)),
                    r && n.push({ id: r, parent_id: d, depth: l, lft: a, rgt: h }),
                    (a = h + 1)
                );
            }
            function s(e) {
        ...
        toHierarchy: function (e) {
            function s(e) {
                ...
                if (o) {
                    var n = { id: o[2] };
                    return (
                        t(e).children(i.listType).children(i.items).length > 0 &&
                            ((n.children = []),
                            t(e)
                                .children(i.listType)
                                .children(i.items)
        ...
        toArray: function () {
            function e(n, l, a) {
                var r,
                    ...
                    h = a + 1;
                return (
                    n.children(s.options.listNodeName).children(s.options.itemNodeName).length > 0 &&
                        (l++,
                        n
                            .children(s.options.listNodeName)
                            .children(s.options.itemNodeName)
                            .each(function () {
                                h = e(t(this), l, h);
                            }),
                        l--),
                    (r = n.data().id),
                    (d = l === i + 1 ? s.rootID : n.parent(s.options.listNodeName).parent(s.options.itemNodeName).data().id),
                    r && o.push({ id: r, parent_id: d, depth: l, left: a, right: h }),
                    (a = h + 1)
                );
            }
            ...
            return (
                l.el
                    .find(l.options.listNodeName)
                    .first()
                    .children(l.options.itemNodeName)
                    .each(function () {
                        n = e(t(this), i + 1, n);
                    }),
        ...
        dragStart: function (e) {
            ...
            if (void 0 === l || !1 !== l) {
                this.placeEl.css("height", o.height()),
                    ...
                    this.dragEl.css({ left: e.pageX - i.offsetX, top: e.pageY - i.offsetY });
                var a,
                    r,
                    d = this.dragEl.find(this.options.itemNodeName);
        ...
        dragStop: function (t) {
            var e = { top: t.pageY, left: t.pageX },
            ...
            this.placeEl.replaceWith(i),
                this.hasNewRoot ? (!0 === this.options.fixed ? this.restoreItemAtIndex(i, s) : this.el.trigger("lostItem"), this.dragRootEl.trigger("gainedItem")) : this.dragRootEl.trigger("change"),
        ...
        dragMove: function (i) {
            var o,
                ...
                r = this.options,
                d = this.mouse;
            this.dragEl.css({ left: i.pageX - d.offsetX, top: i.pageY - d.offsetY }),
                (d.lastX = d.nowX),
                (d.lastY = d.nowY),
                (d.nowX = i.pageX),
                (d.nowY = i.pageY),
            ...
            if (r.scroll)
                if (void 0 !== e.jQuery.fn.scrollParent) {
                    ...
                    p !== s && "HTML" !== p.tagName
                        ? (r.scrollTriggers.bottom + p.offsetHeight - i.pageY < r.scrollSensitivity
                              ? (p.scrollTop = c = p.scrollTop + r.scrollSpeed)
                              : i.pageY - r.scrollTriggers.top < r.scrollSensitivity && (p.scrollTop = c = p.scrollTop - r.scrollSpeed),
                          r.scrollTriggers.right + p.offsetWidth - i.pageX < r.scrollSensitivity
                              ? (p.scrollLeft = c = p.scrollLeft + r.scrollSpeed)
                              : i.pageX - r.scrollTriggers.left < r.scrollSensitivity && (p.scrollLeft = c = p.scrollLeft - r.scrollSpeed))
                        : (i.pageY - t(s).scrollTop() < r.scrollSensitivity
                              ? (c = t(s).scrollTop(t(s).scrollTop() - r.scrollSpeed))
                              : t(e).height() - (i.pageY - t(s).scrollTop()) < r.scrollSensitivity && (c = t(s).scrollTop(t(s).scrollTop() + r.scrollSpeed)),
                          i.pageX - t(s).scrollLeft() < r.scrollSensitivity
                              ? (c = t(s).scrollLeft(t(s).scrollLeft() - r.scrollSpeed))
                              : t(e).width() - (i.pageX - t(s).scrollLeft()) < r.scrollSensitivity && (c = t(s).scrollLeft(t(s).scrollLeft() + r.scrollSpeed)));
            ...
            this.scrollTimer && clearTimeout(this.scrollTimer),
                ...
                d.dirAx !== h
                    ? ((d.distAxX = 0), (d.distAxY = 0))
                    : ((d.distAxX += Math.abs(d.distX)), 0 !== d.dirX && d.dirX !== d.lastDirX && (d.distAxX = 0), (d.distAxY += Math.abs(d.distY)), 0 !== d.dirY && d.dirY !== d.lastDirY && (d.distAxY = 0)),
                (d.dirAx = h),
                d.dirAx &&
                    d.distAxX >= r.threshold &&
                    ((d.distAxX = 0),
                    (a = this.placeEl.prev(r.itemNodeName)),
                    d.distX > 0 &&
                        a.length &&
                        !a.hasClass(r.collapsedClass) &&
                        !a.hasClass(r.noChildrenClass) &&
                        ((o = a.find(r.listNodeName).last()),
                    ...
                    d.distX < 0 && (this.placeEl.next(r.itemNodeName).length || ((n = this.placeEl.parent()), this.placeEl.closest(r.itemNodeName).after(this.placeEl), n.children().length || this.unsetParent(n.parent()))));
            var f = !1;
            if (
            ...
            if (!d.dirAx || m || f) {
                ...
                (n = this.placeEl.parent()),
                    f ? ((o = t(s.createElement(r.listNodeName)).addClass(r.listClass)).append(this.placeEl), this.pointEl.replaceWith(o)) : g ? this.pointEl.before(this.placeEl) : this.pointEl.after(this.placeEl),
        ...
        (t.fn.nestable = function (s) {
            var i = this,
                ...
                l = arguments;
            return (
                "Nestable" in e || ((e.Nestable = {}), (Nestable.counter = 0)),
                i.each(function () {
